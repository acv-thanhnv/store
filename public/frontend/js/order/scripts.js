!function(e, t) {
    ...
    function f(e, t, n, r) {
        ...
        , u = s(), l = n && n[3] || (pe.cssNumber[t] ? "" : "px"), c = (pe.cssNumber[t] || "px" !== l && +u) && Re.exec(pe.css(e, t));
        if (c && c[3] !== l) {
            l = l || c[3],
            n = n || [],
            c = +u || 1;
        ...
        for (var o, a, s, u, l, c, d, f = e.length, v = p(t), y = [], x = 0; f > x; x++)
            if ((a = e[x]) || 0 === a)
                if ("object" === pe.type(a))
                    ...
                    !de.tbody)
                        for (a = "table" !== l || Ve.test(a) ? "<table>" !== d[1] || Ve.test(a) ? 0 : u : u.firstChild,
    ...
    function k(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            de.html5Clone && e.innerHTML && !pe.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Be.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function E(e, t, n, r) {
        ...
        i || r)) {
            ...
            if (a)
                ...
                c = 0; a > c; c++)
                    o = s[c],
                    $e.test(o.type || "") && !pe._data(o, "globalEval") && pe.contains(u, o) && (o.src ? pe._evalUrl && pe._evalUrl(o.src) : pe.globalEval((o.text || o.textContent || o.innerHTML || "").replace(it, "")));
            l = i = null
        }
        return e
    }
    ...
    function q(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
            ...
            "" === r.style.display && Oe(r) && (o[a] = pe._data(r, "olddisplay", j(r.nodeName)))) : (i = Oe(r),
    ...
    function R(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)
            ...
            r ? ("content" === n && (a -= pe.css(e, "padding" + Me[o], !0, i)),
            "margin" !== n && (a -= pe.css(e, "border" + Me[o] + "Width", !0, i))) : (a += pe.css(e, "padding" + Me[o], !0, i),
            "padding" !== n && (a += pe.css(e, "border" + Me[o] + "Width", !0, i)));
        return a
    }
    function M(e, t, n) {
        var r = !0
    ...
    function _(e, t, n) {
        for (var r, i = (I.tweeners[t] || []).concat(I.tweeners["*"]), o = 0, a = i.length; a > o; o++)
            if (r = i[o].call(n, t, e))
                return r
    }
    function $(e, t, n) {
        ...
        l = pe.css(e, "display"),
        "inline" === ("none" === l ? pe._data(e, "olddisplay") || j(e.nodeName) : l) && "none" === pe.css(e, "float") && (de.inlineBlockNeedsLayout && "inline" !== j(e.nodeName) ? f.zoom = 1 : f.display = "inline-block")),
    ...
    function I(e, t, n) {
        var r, i, o = 0, a = I.prefilters.length, s = pe.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = St || F(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++)
                l.tweens[a].run(o);
    ...
    var ye = function(e) {
        function t(e, t, n, r) {
            ...
            "string" != typeof e || !e || 1 !== g && 9 !== g && 11 !== g)
                return n;
            if (!r && ((t ? t.ownerDocument || t : F) !== j && A(t),
            t = t || j,
            H)) {
                if (11 !== g && (d = ge.exec(e)))
                    if (i = d[1]) {
                        ...
                        if (d[2])
                            ...
                            n;
                        if ((i = d[3]) && x.getElementsByClassName && t.getElementsByClassName)
                ...
                if (x.qsa && !I[e + " "] && (!q || !q.test(e))) {
                    if (1 !== g)
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(ve, "\\$&") : t.setAttribute("id", s = O),
                        f = C(e),
                        o = f.length,
                        l = ce.test(s) ? "#" + s : "[id='" + s + "']"; o--; )
                            f[o] = l + " " + c(f[o]);
                        p = f.join(","),
        ...
        function g(e, t, n, i, o, a) {
            ...
            o && !o[O] && (o = g(o, a)),
            r(function(r, a, s, u) {
                var l, c, d, f = [], g = [], m = a.length, v = r || p(t || "*", s.nodeType ? [s] : s, []), y = !e || !r && t ? v : h(v, f, e, s, u), x = n ? o || (r ? e : m || i) ? [] : a : y;
                if (n && n(y, x, s, u),
                i)
                    for (l = h(x, g),
                    i(l, [], s, u),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = x.length; c--; )
                            (d = x[c]) && (l = o ? Z(r, d) : f[c]) > -1 && (r[l] = !(a[l] = d))
                    }
                } else
                    x = h(x === a ? x.splice(m, x.length) : x),
        ...
        function v(e, n) {
            var i = n.length > 0
              ...
              , a = function(r, a, s, u, l) {
                var c, d, f, p = 0, g = "0", m = r && [], v = [], y = k, x = r || o && b.find.TAG("*", l), w = B += null == y ? 1 : Math.random() || .1, N = x.length;
                for (l && (k = a === j || a || l); g !== N && null != (c = x[g]); g++) {
                    if (o && c) {
                        for (d = 0,
                        a || c.ownerDocument === j || (A(c),
                        s = !H); f = e[d++]; )
                            if (f(c, a || j, s)) {
                                u.push(c);
                                break
        ...
        var y, x, b, w, N, C, S, T, k, E, D, A, j, L, H, q, P, R, M, O = "sizzle" + 1 * new Date, F = e.document, B = 0, _ = 0, $ = n(), W = n(), I = n(), z = function(e, t) {
            return e === t && (D = !0),
            0
        }, X = 1 << 31, V = {}.hasOwnProperty, U = [], K = U.pop, Y = U.push, G = U.push, Q = U.slice, Z = function(e, t) {
            for (var n = 0, r = e.length; r > n; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, J = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ee = "[\\x20\\t\\r\\n\\f]", te = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ne = "\\[" + ee + "*(" + te + ")(?:" + ee + "*([*^$|!~]?=)" + ee + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + te + "))|)" + ee + "*\\]", re = ":(" + te + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ne + ")*)|.*)\\)|)", ie = new RegExp(ee + "+","g"), oe = new RegExp("^" + ee + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ee + "+$","g"), ae = new RegExp("^" + ee + "*," + ee + "*"), se = new RegExp("^" + ee + "*([>+~]|" + ee + ")" + ee + "*"), ue = new RegExp("=" + ee + "*([^\\]'\"]*?)" + ee + "*\\]","g"), le = new RegExp(re), ce = new RegExp("^" + te + "$"), de = {
            ID: new RegExp("^#(" + te + ")"),
            CLASS: new RegExp("^\\.(" + te + ")"),
            TAG: new RegExp("^(" + te + "|[*])"),
            ATTR: new RegExp("^" + ne),
        ...
        }, fe = /^(?:input|select|textarea|button)$/i, pe = /^h\d$/i, he = /^[^{]+\{\s*\[native \w/, ge = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, me = /[+~]/, ve = /'|\\/g, ye = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)","ig"), xe = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        A = t.setDocument = function(e) {
            ...
            L = j.documentElement,
            H = !N(j),
            (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", be, !1) : n.attachEvent && n.attachEvent("onunload", be)),
            ...
            x.getById = i(function(e) {
                ...
                !j.getElementsByName || !j.getElementsByName(O).length
            }),
            ...
            P = [],
            q = [],
            (x.qsa = he.test(j.querySelectorAll)) && (i(function(e) {
                ...
                e.querySelectorAll("[selected]").length || q.push("\\[" + ee + "*(?:value|" + J + ")"),
            ...
            (x.matchesSelector = he.test(R = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) && i(function(e) {
            ...
            z = t ? function(e, t) {
                ...
                1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === j || e.ownerDocument === F && M(F, e) ? -1 : t === j || t.ownerDocument === F && M(F, t) ? 1 : E ? Z(E, e) - Z(E, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return D = !0,
                ...
                if (!i || !o)
                    return e === j ? -1 : t === j ? 1 : i ? -1 : o ? 1 : E ? Z(E, e) - Z(E, t) : 0;
                if (i === o)
                    return a(e, t);
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(ue, "='$1']"),
            x.matchesSelector && H && !I[n + " "] && (!P || !P.test(n)) && (!q || !q.test(n)))
                try {
                    var r = R.call(e, n);
        ...
        t.attr = function(e, t) {
            ...
            var n = b.attrHandle[t.toLowerCase()]
              , r = n && V.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
        ...
        b = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return de.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && le.test(n) && (t = C(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        ...
                        if (m) {
                            ...
                            x = p),
                            !1 === x)
                                for (; (f = ++p && f && f[g] || (x = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++x || (y && (d = f[O] || (f[O] = {}),
                                c = d[f.uniqueID] || (d[f.uniqueID] = {}),
                                c[e] = [B, x]),
                                f !== t)); )
                                    ;
        ...
        T = t.select = function(e, t, n, r) {
            ...
            1 === f.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && x.getById && 9 === t.nodeType && H && b.relative[o[1].type]) {
                    if (!(t = (b.find.ID(a.matches[0].replace(ye, xe), t) || [])[0]))
                        return n;
                    d && (t = t.parentNode),
            ...
            return (d || S(e, f))(r, t, !H, n, !t || me.test(e) && u(t.parentNode) || t),
            n
        }
        ,
    ...
    (pe.fn.init = function(e, t, n) {
        ...
        if (n = n || Se,
        "string" == typeof e) {
            if (!(r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : Te.exec(e)) || !r[1] && t)
                return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (r[1]) {
                if (t = t instanceof pe ? t[0] : t,
                pe.merge(this, pe.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : re, !0)),
                Ne.test(r[1]) && pe.isPlainObject(t))
                    for (r in t)
    ...
    pe.each({
        ...
        pe.fn[e] = function(n, r) {
            ...
            this.length > 1 && (Ee[e] || (i = pe.uniqueSort(i)),
    ...
    pe.event = {
            ...
            if (m && (c = m.events)) {
                ...
                l = t.length; l--; )
                    ...
                    p) {
                        ...
                        u && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, m.handle) || pe.removeEvent(e, p, m.handle),
                        delete c[p])
                    } else
                        for (p in c)
        ...
        trigger: function(t, n, r, i) {
            ...
            i || !l.trigger || !1 !== l.trigger.apply(r, n))) {
                if (!i && !l.noBubble && !pe.isWindow(r)) {
                    ...
                    Ge.test(u + p) || (s = s.parentNode); s; s = s.parentNode)
                        f.push(s),
                        c = s;
        ...
        fix: function(e) {
            ...
            for (a || (this.fixHooks[i] = a = Ye.test(i) ? this.mouseHooks : Ke.test(i) ? this.keyHooks : {}),
    ...
    pe.Event = function(e, t) {
        ...
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? y : x) : this.type = e,
        t && pe.extend(this, t),
    ...
    pe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (de.html5Clone || pe.isXMLDoc(e) || !Je.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (at.innerHTML = e.outerHTML,
    ...
    pe.fn.extend({
        ...
        html: function(e) {
            return Fe(this, function(e) {
                ...
                if ("string" == typeof e && !tt.test(e) && (de.htmlSerialize || !Je.test(e)) && (de.leadingWhitespace || !We.test(e)) && !ze[(_e.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    var st, ut = {
        HTML: "block",
        BODY: "block"
    }, lt = /^margin/, ct = new RegExp("^(" + Pe + ")(?!px)[a-z%]+$","i"), dt = function(e, t, n, r) {
        var i, o, a = {};
        for (o in t)
            a[o] = e.style[o],
            e.style[o] = t[o];
    ...
    pe.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (o = typeof n,
                "string" === o && (i = Re.exec(n)) && i[1] && (n = f(e, t, i),
                o = "number"),
    ...
    pe.each(["height", "width"], function(e, t) {
        pe.cssHooks[t] = {
            ...
            set: function(e, n, r) {
                var i = r && pt(e);
                return P(e, n, r ? R(e, t, r, de.boxSizing && "border-box" === pe.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    }),
    ...
    pe.each({
        ...
        lt.test(e) || (pe.cssHooks[e + t].set = P)
    }),
    pe.fn.extend({
        css: function(e, t) {
    ...
    pe.fx.step = {};
    var St, Tt, kt = /^(?:toggle|show|hide)$/, Et = /queueHooks$/;
    ...
    pe.fn.extend({
        val: function(e) {
            ...
            })) : i ? (t = pe.valHooks[i.type] || pe.valHooks[i.nodeName.toLowerCase()],
            t && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value,
            "string" == typeof n ? n.replace(Dt, "") : null == n ? "" : n)) : void 0
        }
    }),
    pe.extend({
        valHooks: {
    ...
    var jt, Lt, Ht = pe.expr.attrHandle, qt = /^(?:checked|selected)$/i, Pt = de.getSetAttribute, Rt = de.input;
    pe.fn.extend({
        attr: function(e, t) {
    ...
    pe.extend({
        ...
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[i++]; )
                    r = pe.propFix[n] || n,
                    pe.expr.match.bool.test(n) ? Rt && Pt || !qt.test(n) ? e[r] = !1 : e[pe.camelCase("default-" + n)] = e[r] = !1 : pe.attr(e, n, ""),
                    e.removeAttribute(Pt ? n : r)
        }
    }),
    Lt = {
        set: function(e, t, n) {
            return !1 === t ? pe.removeAttr(e, n) : Rt && Pt || !qt.test(n) ? e.setAttribute(!Pt && pe.propFix[n] || n, n) : e[pe.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
    pe.each(pe.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var n = Ht[t] || pe.find.attr;
        Rt && Pt || !qt.test(t) ? Ht[t] = function(e, t, r) {
            var i, o;
            return r || (o = Ht[t],
            Ht[t] = i,
    ...
    pe.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, i) {
                ...
                r && (x = K(f, N, r)),
                x = Y(f, x, N, o),
                o ? (f.ifModified && (w = N.getResponseHeader("Last-Modified"),
                w && (pe.lastModified[a] = w),
                (w = N.getResponseHeader("etag")) && (pe.etag[a] = w)),
                ...
                N.status = t,
                N.statusText = (n || C) + "",
                o ? g.resolveWith(p, [d, C, N]) : g.rejectWith(p, [N, C, y]),
                N.statusCode(v),
                v = void 0,
                l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [N, f, o ? d : y]),
                m.fireWith(p, [N, C]),
                l && (h.trigger("ajaxComplete", [N, f]),
                --pe.active || pe.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t,
            t = void 0),
            n = n || {};
            var i, o, a, s, u, l, c, d, f = pe.ajaxSetup({}, n), p = f.context || f, h = f.context && (p.nodeType || p.jquery) ? pe(p) : pe.event, g = pe.Deferred(), m = pe.Callbacks("once memory"), v = f.statusCode || {}, y = {}, x = {}, b = 0, w = "canceled", N = {
                readyState: 0,
            ...
            if (g.promise(N).complete = m.add,
            N.success = N.done,
            N.error = N.fail,
            f.url = ((t || f.url || Jt) + "").replace(It, "").replace(Kt, en[1] + "//"),
            f.type = n.method || n.type || f.method || f.type,
            f.dataTypes = pe.trim(f.dataType || "*").toLowerCase().match(De) || [""],
            ...
            a = f.url,
            f.hasContent || (f.data && (a = f.url += ($t.test(a) ? "&" : "?") + f.data,
            delete f.data),
            !1 === f.cache && (f.url = zt.test(a) ? a.replace(zt, "$1_=" + _t++) : a + ($t.test(a) ? "&" : "?") + "_=" + _t++)),
            f.ifModified && (pe.lastModified[a] && N.setRequestHeader("If-Modified-Since", pe.lastModified[a]),
            pe.etag[a] && N.setRequestHeader("If-None-Match", pe.etag[a])),
            (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && N.setRequestHeader("Content-Type", f.contentType),
            N.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Zt + "; q=0.01" : "") : f.accepts["*"]);
            for (o in f.headers)
                N.setRequestHeader(o, f.headers[o]);
            if (f.beforeSend && (!1 === f.beforeSend.call(p, N, f) || 2 === b))
                return N.abort();
            w = "abort";
            for (o in {
                success: 1,
    ...
    pe.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && an.test(this.nodeName) && !on.test(e) && (this.checked || !Be.test(e))
            }).map(function(e, t) {
                var n = pe(this).val();
    ...
    pe.ajaxSettings.xhr = void 0 !== e.ActiveXObject ? function() {
        return this.isLocal ? ee() : re.documentMode > 8 ? J() : /^(get|post|head|put|delete|options)$/i.test(this.type) && J() || ee()
    }
    : J;
    var sn = 0
      , un = {}
    ...
    (ln = de.ajax = !!ln) && pe.ajaxTransport(function(t) {
    ...
    pe.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        s ? t[s] = t[s].replace(dn, "$1" + i) : !1 !== t.jsonp && (t.url += ($t.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
...
function(e) {
    ...
    function r(t, n) {
        e.each(n, function(e, r) {
            "function" == typeof r ? n[e] = r(t, n, e) : "function" == typeof t.autoNumeric[r] && (n[e] = t.autoNumeric[r](t, n, e))
        })
    }
    function i(e, t) {
    ...
    function o(e, t) {
        ...
        var u = t.aNeg ? "([-\\" + t.aNeg + "]?)" : "(-?)";
        t.aNegRegAutoStrip = u,
        t.skipFirstAutoStrip = new RegExp(u + "[^-" + (t.aNeg ? "\\" + t.aNeg : "") + "\\" + t.aDec + "\\d].*?(\\d|\\" + t.aDec + "\\d)"),
        t.skipLastAutoStrip = new RegExp("(\\d\\" + t.aDec + "?)[^\\" + t.aDec + "\\d]\\D*$");
        var l = "-" + t.aNum + "\\" + t.aDec;
        return t.allowedAutoStrip = new RegExp("[^" + l + "]","gi"),
        t.numRegAutoStrip = new RegExp(u + "(?:\\" + t.aDec + "?(\\d+\\" + t.aDec + "\\d+)|(\\d*(?:\\" + t.aDec + "\\d*)?))"),
        t
    }
    function a(e, t, n) {
        if (t.aSign)
            for (; e.indexOf(t.aSign) > -1; )
                e = e.replace(t.aSign, "");
        ...
        if (e = r ? [r[1], r[2], r[3]].join("") : "",
        ("allow" === t.lZero || "keep" === t.lZero) && "strip" !== n) {
            var i = []
              , o = "";
            i = e.split(t.aDec),
            -1 !== i[0].indexOf("-") && (o = "-",
            i[0] = i[0].replace("-", "")),
            i[0].length > t.mInt && "0" === i[0].charAt(0) && (i[0] = i[0].slice(1)),
            e = o + i.join(t.aDec)
        }
        if (n && "deny" === t.lZero || n && "allow" === t.lZero && !1 === t.allowLeading) {
            var a = "^" + t.aNegRegAutoStrip + "0*(\\d" + ("leading" === n ? ")" : "|$)");
            a = new RegExp(a),
            e = e.replace(a, "$1$2")
        }
        return e
    ...
    function s(e, t) {
        if ("p" === t.pSign) {
            var n = t.nBracket.split(",");
            t.hasFocus || t.removeBrackets ? (t.hasFocus && e.charAt(0) === n[0] || t.removeBrackets && e.charAt(0) === n[0]) && (e = e.replace(n[0], t.aNeg),
            e = e.replace(n[1], "")) : (e = e.replace(t.aNeg, ""),
            e = n[0] + e + n[1])
        }
        return e
    }
    function u(e, t) {
        if (e) {
            ...
            if (n < 1e-6 && n > -1)
                e = +e,
                e < 1e-6 && e > 0 && (e = (e + 10).toString(),
                e = e.substring(1)),
                e < 0 && e > -1 && (e = (e - 10).toString(),
                e = "-" + e.substring(2)),
                e = e.toString();
            else {
                var r = e.split(".");
                void 0 !== r[1] && (0 == +r[1] ? e = r[0] : (r[1] = r[1].replace(/0*$/, ""),
                e = r.join(".")))
            }
        }
    ...
    function f(e, t) {
        ...
        if (null !== r)
            return r;
        var i = "";
        i = 2 === t.dGroup ? /(\d)((\d)(\d{2}?)+)$/ : 4 === t.dGroup ? /(\d)((\d{4}?)+)$/ : /(\d)((\d{3}?)+)$/;
        var o = e.split(t.aDec);
        t.altDec && 1 === o.length && (o = e.split(t.altDec));
        var u = o[0];
        if (t.aSep)
            for (; i.test(u); )
                u = u.replace(i, "$1" + t.aSep + "$2");
        if (0 !== t.mDec && o.length > 1 ? (o[1].length > t.mDec && (o[1] = o[1].substring(0, t.mDec)),
        e = u + t.aDec + o[1]) : e = u,
        t.aSign) {
            var l = -1 !== e.indexOf(t.aNeg);
            e = e.replace(t.aNeg, ""),
            e = "p" === t.pSign ? t.aSign + e : e + t.aSign,
            l && (e = t.aNeg + e)
        }
        return n < 0 && null !== t.nBracket && (e = s(e, t)),
        e
    }
    function p(e, t) {
        e = "" === e ? "0" : e.toString(),
        i(t, "mDec"),
        "CHF" === t.mRound && (e = (Math.round(20 * e) / 20).toString());
        var n = ""
          , r = 0
          , o = ""
          , a = "boolean" == typeof t.aPad || null === t.aPad ? t.aPad ? t.mDec : 0 : +t.aPad
          , s = function(e) {
            var t = 0 === a ? /(\.(?:\d*[1-9])?)0*$/ : 1 === a ? /(\.\d(?:\d*[1-9])?)0*$/ : new RegExp("(\\.\\d{" + a + "}(?:\\d*[1-9])?)0*$");
        ...
        if (c <= t.mDec) {
            ...
            c < a) {
                -1 === u && (n += t.aDec);
                for (var d = "000000"; c < a; )
                    d = d.substring(0, a - c),
                    n += d,
                    c += d.length
            } else
                c > a ? n = s(n) : 0 === c && 0 === a && (n = n.replace(/\.$/, ""));
            if ("CHF" !== t.mRound)
                return 0 == +n ? n : o + n;
            "CHF" === t.mRound && (u = n.lastIndexOf("."),
            e = n)
        }
        var f = u + t.mDec
          , p = +e.charAt(f + 1)
          , h = e.substring(0, f + 1).split("")
          , g = "." === e.charAt(f) ? e.charAt(f - 1) % 2 : e.charAt(f) % 2
          , m = !0;
        if (1 !== g && (g = 0 === g && e.substring(f + 2, e.length) > 0 ? 1 : 0),
        p > 4 && "S" === t.mRound || p > 4 && "A" === t.mRound && "" === o || p > 5 && "A" === t.mRound && "-" === o || p > 5 && "s" === t.mRound || p > 5 && "a" === t.mRound && "" === o || p > 4 && "a" === t.mRound && "-" === o || p > 5 && "B" === t.mRound || 5 === p && "B" === t.mRound && 1 === g || p > 0 && "C" === t.mRound && "" === o || p > 0 && "F" === t.mRound && "-" === o || p > 0 && "U" === t.mRound || "CHF" === t.mRound)
            for (r = h.length - 1; r >= 0; r -= 1)
                if ("." !== h[r]) {
                    if ("CHF" === t.mRound && h[r] <= 2 && m) {
                        h[r] = 0,
                        m = !1;
                        break
                    }
                    if ("CHF" === t.mRound && h[r] <= 7 && m) {
                        h[r] = 5,
                        m = !1;
                        break
                    }
                    if ("CHF" === t.mRound && m ? (h[r] = 10,
                    m = !1) : h[r] = +h[r] + 1,
                    h[r] < 10)
                        break;
                    r > 0 && (h[r] = "0")
                }
        return h = h.slice(0, f + 1),
        n = s(h.join("")),
        0 == +n ? n : o + n
    }
    function h(e, t, n) {
        var r = t.aDec
          , i = t.mDec;
        if (e = "paste" === n ? p(e, t) : e,
        r && i) {
            var o = e.split(r);
            o[1] && o[1].length > i && (i > 0 ? (o[1] = o[1].substring(0, i),
            e = o.join(r)) : e = o[0])
        }
        return e
    }
    ...
    function y(e, t, n) {
        ...
        var i = r.holder;
        return (void 0 === i && t || n) && (i = new m(e.get(0),t),
        r.holder = i),
        i
    }
    m.prototype = {
        ...
        getBeforeAfterStriped: function() {
            ...
            return e[0] = a(e[0], this.settingsClone),
            e[1] = a(e[1], this.settingsClone),
            e
        },
        normalizeParts: function(e, t) {
            var n = this.settingsClone;
            t = a(t, n),
            "" !== (e = a(e, n, !!t.match(/^\d/) || "leading")) && e !== n.aNeg || "deny" !== n.lZero || t > "" && (t = t.replace(/^0*(\d)/, "$1"));
            var r = e + t;
            if (n.aDec) {
                var i = r.match(new RegExp("^" + n.aNegRegAutoStrip + "\\" + n.aDec));
                i && (e = e.replace(i[1], i[1] + "0"),
                r = e + t)
            }
            return "zero" !== n.wEmpty || r !== n.aNeg && "" !== r || (e += "0"),
            [e, t]
        },
        setValueParts: function(e, t, n) {
            var r = this.settingsClone
              , i = this.normalizeParts(e, t)
              , o = i.join("")
              , a = i[0].length;
            return !!g(o, r) && (o = h(o, r, n),
        ...
        signPosition: function() {
            ...
            if (t) {
                var r = t.length;
                if ("p" === e.pSign) {
                    return e.aNeg && n.value && n.value.charAt(0) === e.aNeg ? [1, r + 1] : [0, r]
                }
        ...
        expandSelectionOnSign: function(e) {
            var t = this.signPosition()
              , n = this.selection;
            n.start < t[1] && n.end > t[0] && ((n.start < t[0] || n.end > t[1]) && this.value.substring(Math.max(n.start, t[0]), Math.min(n.end, t[1])).match(/^\s*$/) ? n.start < t[0] ? this.setSelection(n.start, t[0], e) : this.setSelection(t[1], n.end, e) : this.setSelection(Math.min(n.start, t[0]), Math.max(n.end, t[1]), e))
        },
        checkPaste: function() {
            if (void 0 !== this.valuePartsBeforePaste) {
                ...
                e[0] = e[0].substr(0, t[0].length) + a(e[0].substr(t[0].length), this.settingsClone),
        ...
        skipAllways: function(e) {
            var t = this.kdCode
              ...
              , i = this.cmdKey
              , o = this.shiftKey;
            if ((r || i) && "keyup" === e.type && void 0 !== this.valuePartsBeforePaste || o && 45 === t)
                return this.checkPaste(),
                !1;
            if (t >= 112 && t <= 123 || t >= 91 && t <= 93 || t >= 9 && t <= 31 || t < 8 && (0 === n || n === t) || 144 === t || 145 === t || 45 === t || 224 === t)
                return !0;
            if ((r || i) && 65 === t)
                return !0;
            if ((r || i) && (67 === t || 86 === t || 88 === t))
            ...
            if (r || i)
                return !0;
            if (37 === t || 39 === t) {
                var a = this.settingsClone.aSep
                  , s = this.selection.start
                  , u = this.that.value;
                return "keydown" === e.type && a && !this.shiftKey && (37 === t && u.charAt(s - 2) === a ? this.setPosition(s - 1) : 39 === t && u.charAt(s + 1) === a && this.setPosition(s + 1)),
                !0
            }
            return t >= 34 && t <= 40
        },
        processAllways: function() {
            ...
            this.setValueParts(e[0], e[1])) : (e = this.getBeforeAfterStriped(),
            8 === this.kdCode ? e[0] = e[0].substring(0, e[0].length - 1) : e[1] = e[1].substring(1, e[1].length),
        ...
        processKeypress: function() {
            var e = this.settingsClone
              ...
              , r = n[0]
              , i = n[1];
            return t === e.aDec || e.altDec && t === e.altDec || ("." === t || "," === t) && 110 === this.kdCode ? !e.mDec || !e.aDec || !!(e.aNeg && i.indexOf(e.aNeg) > -1) || r.indexOf(e.aDec) > -1 || i.indexOf(e.aDec) > 0 || (0 === i.indexOf(e.aDec) && (i = i.substr(1)),
            this.setValueParts(r + e.aDec, i),
            !0) : "-" === t || "+" === t ? !e.aNeg || ("" === r && i.indexOf(e.aNeg) > -1 && (r = e.aNeg,
            i = i.substring(1, i.length)),
            r = r.charAt(0) === e.aNeg ? r.substring(1, r.length) : "-" === t ? e.aNeg + r : r,
            this.setValueParts(r, i),
            !0) : !(t >= "0" && t <= "9" && (e.aNeg && "" === r && i.indexOf(e.aNeg) > -1 && (r = e.aNeg,
            i = i.substring(1, i.length)),
            e.vMax <= 0 && e.vMin < e.vMax && -1 === this.value.indexOf(e.aNeg) && "0" !== t && (r = e.aNeg + r),
        ...
        formatQuick: function() {
            var e = this.settingsClone
              ...
              , n = this.value;
            if (("" === e.aSep || "" !== e.aSep && -1 === n.indexOf(e.aSep)) && ("" === e.aSign || "" !== e.aSign && -1 === n.indexOf(e.aSign))) {
                var r = []
                  , i = "";
                r = n.split(e.aDec),
                r[0].indexOf("-") > -1 && (i = "-",
                r[0] = r[0].replace("-", ""),
                t[0] = t[0].replace("-", "")),
                r[0].length > e.mInt && "0" === t[0].charAt(0) && (t[0] = t[0].slice(1)),
                t[0] = i + t[0]
            }
            ...
            this.that.value !== o && (this.that.value = o,
            this.setPosition(a)),
            this.formatted = !0
        }
    };
    var x = {
        init: function(t) {
            return this.each(function() {
                var r = e(this)
                  ...
                  , o = r.data()
                  , u = r.is("input[type=text], input[type=hidden], input[type=tel], input:not([type])");
                if ("object" == typeof i)
                    return this;
                i = e.extend({}, e.fn.autoNumeric.defaults, o, t, {
                    aNum: "0123456789",
                    hasFocus: !1,
                    removeBrackets: !1,
                    runOnce: !1,
                ...
                i.aDec === i.aSep && e.error("autoNumeric will not function properly when the decimal character aDec: '" + i.aDec + "' and thousand separator aSep: '" + i.aSep + "' are the same character"),
                r.data("autoNumeric", i);
                var h = y(r, i);
                if (u || "input" !== r.prop("tagName").toLowerCase() || e.error('The input type "' + r.prop("type") + '" is not supported by autoNumeric()'),
                -1 === e.inArray(r.prop("tagName").toLowerCase(), i.tagList) && "input" !== r.prop("tagName").toLowerCase() && e.error("The <" + r.prop("tagName").toLowerCase() + "> is not supported by autoNumeric()"),
                !1 === i.runOnce && i.aForm) {
                    if (u) {
                        var m = !0;
                        "" === r[0].value && "empty" === i.wEmpty && (r[0].value = "",
                        m = !1),
                        "" === r[0].value && "sign" === i.wEmpty && (r[0].value = i.aSign,
                        m = !1),
                        m && "" !== r.val() && (null === i.anDefault && r[0].value === r.prop("defaultValue") || null !== i.anDefault && i.anDefault.toString() === r.val()) && r.autoNumeric("set", r.val())
                    }
                    -1 !== e.inArray(r.prop("tagName").toLowerCase(), i.tagList) && "" !== r.text() && r.autoNumeric("set", r.text())
                }
                i.runOnce = !0,
                r.is("input[type=text], input[type=hidden], input[type=tel], input:not([type])") && (r.on("keydown.autoNumeric", function(t) {
                    return h = y(r),
                    h.settings.aDec === h.settings.aSep && e.error("autoNumeric will not function properly when the decimal character aDec: '" + h.settings.aDec + "' and thousand separator aSep: '" + h.settings.aSep + "' are the same character"),
                    h.that.readOnly ? (h.processed = !0,
                    !0) : (h.init(t),
                    h.skipAllways(t) ? (h.processed = !0,
                    !0) : h.processAllways() ? (h.processed = !0,
                    h.formatQuick(),
                    t.preventDefault(),
                    !1) : (h.formatted = !1,
                    !0))
                ...
                r.on("keypress.autoNumeric", function(e) {
                    ...
                    var t = h.processed;
                    return h.init(e),
                    !!h.skipAllways(e) || (t ? (e.preventDefault(),
                    !1) : h.processAllways() || h.processKeypress() ? (h.formatQuick(),
                    e.preventDefault(),
                    !1) : void (h.formatted = !1))
                }),
                r.on("keyup.autoNumeric", function(e) {
                    h = y(r),
                    h.init(e);
                    var t = h.skipAllways(e)
                      , i = h.kdCode;
                    return h.kdCode = 0,
                    delete h.valuePartsBeforePaste,
                    r[0].value === h.settings.aSign ? "s" === h.settings.pSign ? n(this, 0, 0) : n(this, h.settings.aSign.length, h.settings.aSign.length) : 9 === i && n(this, 0, r.val().length),
                    !!t || "" === this.value || void (h.formatted || h.formatQuick())
                }),
                r.on("focusin.autoNumeric", function() {
                    h = y(r);
                    var e = h.settingsClone;
                    if (e.hasFocus = !0,
                    null !== e.nBracket) {
                        var t = r.val();
                        r.val(s(t, e))
                ...
                r.on("focusout.autoNumeric", function() {
                    ...
                    var e = h.settingsClone
                      ...
                      , i = "";
                    e.hasFocus = !1,
                    "allow" === e.lZero && (e.allowLeading = !1,
                    i = "leading"),
                    "" !== t && (t = a(t, e, i),
                    null === d(t, e) && g(t, e, r[0]) ? (t = l(t, e.aDec, e.aNeg),
                    t = p(t, e),
                    t = c(t, e.aDec, e.aNeg)) : t = "");
                    var o = d(t, e, !1);
                    null === o && (o = f(t, e)),
                    o === h.inVal && o === n || (r.val(o),
                    r.change(),
                    delete h.inVal)
                }))
            })
        ...
        update: function(t) {
            return e(this).each(function() {
                ...
                "object" != typeof r && e.error("You must initialize autoNumeric('init', {options}) prior to calling the 'update' method");
                var i = n.autoNumeric("get");
                if (r = e.extend(r, t),
                y(n, r, !0),
                r.aDec === r.aSep && e.error("autoNumeric will not function properly when the decimal character aDec: '" + r.aDec + "' and thousand separator aSep: '" + r.aSep + "' are the same character"),
            ...
            if (null !== t && !isNaN(t))
                return e(this).each(function() {
                    var n = v(e(this))
                      ...
                      , i = t.toString()
                      , o = t.toString()
                      , a = n.is("input[type=text], input[type=hidden], input[type=tel], input:not([type])");
                    return "object" != typeof r && e.error("You must initialize autoNumeric('init', {options}) prior to calling the 'set' method"),
                    o !== n.attr("value") && o !== n.text() || !1 !== r.runOnce || (i = i.replace(",", ".")),
                    e.isNumeric(+i) || e.error("The value (" + i + ") being 'set' is not numeric and has caused a error to be thrown"),
                    i = u(i, r),
                    r.setEvent = !0,
                    i.toString(),
                    "" !== i && (i = p(i, r)),
                    ...
                    g(i, r) || (i = p("", r)),
                    i = f(i, r),
                    a ? n.val(i) : -1 !== e.inArray(n.prop("tagName").toLowerCase(), r.tagList) && n.text(i)
                })
        },
        get: function() {
            var t = v(e(this))
              , n = t.data("autoNumeric");
            "object" != typeof n && e.error("You must initialize autoNumeric('init', {options}) prior to calling the 'get' method");
            var r = "";
            return t.is("input[type=text], input[type=hidden], input[type=tel], input:not([type])") ? r = t.eq(0).val() : -1 !== e.inArray(t.prop("tagName").toLowerCase(), n.tagList) ? r = t.eq(0).text() : e.error("The <" + t.prop("tagName").toLowerCase() + "> is not supported by autoNumeric()"),
            "" === r && "empty" === n.wEmpty || r === n.aSign && ("sign" === n.wEmpty || "empty" === n.wEmpty) ? "" : ("" !== r && null !== n.nBracket && (n.removeBrackets = !0,
            r = s(r, n),
            n.removeBrackets = !1),
            (n.runOnce || !1 === n.aForm) && (r = a(r, n)),
            r = l(r, n.aDec, n.aNeg),
            0 == +r && "keep" !== n.lZero && (r = "0"),
            "keep" === n.lZero ? r : r = u(r, n))
        },
        getString: function() {
            var t = !1
              , n = v(e(this))
              ...
              , d = /^(?:checkbox|radio)$/i
              , f = /^(?:button|checkbox|color|date|datetime|datetime-local|email|file|image|month|number|password|radio|range|reset|search|submit|time|url|week)/i
              , p = 0;
            return e.each(a[0], function(e, t) {
                "" === t.name || !c.test(t.localName) || l.test(t.type) || t.disabled || !t.checked && d.test(t.type) ? u.push(-1) : (u.push(p),
                p += 1)
            }),
            p = 0,
            e.each(a[0], function(e, t) {
                "input" !== t.localName || "" !== t.type && "text" !== t.type && "hidden" !== t.type && "tel" !== t.type ? (s.push(-1),
                "input" === t.localName && f.test(t.type) && (p += 1)) : (s.push(p),
                p += 1)
            }),
            e.each(i, function(n, r) {
                ...
                var a = e.inArray(n, u);
                if (a > -1 && s[a] > -1) {
                    "object" == typeof e("form:eq(" + o + ") input:eq(" + s[a] + ")").data("autoNumeric") && null !== r[1] && (r[1] = e("form:eq(" + o + ") input:eq(" + s[a] + ")").autoNumeric("get").toString(),
                    i[n] = r.join("="),
                    t = !0)
                }
            }),
            t || e.error("You must initialize autoNumeric('init', {options}) prior to calling the 'getString' method"),
            i.join("&")
        },
        getArray: function() {
            var t = !1
            ...
            return e.each(o[0], function(e, t) {
                "" === t.name || !l.test(t.localName) || u.test(t.type) || t.disabled || !t.checked && c.test(t.type) ? s.push(-1) : (s.push(f),
                f += 1)
            }),
            f = 0,
            e.each(o[0], function(e, t) {
                "input" !== t.localName || "" !== t.type && "text" !== t.type && "hidden" !== t.type && "tel" !== t.type ? (a.push(-1),
                "input" === t.localName && d.test(t.type) && (f += 1)) : (a.push(f),
                f += 1)
            }),
            e.each(r, function(n, r) {
                var o = e.inArray(n, s);
                if (o > -1 && a[o] > -1) {
                    "object" == typeof e("form:eq(" + i + ") input:eq(" + a[o] + ")").data("autoNumeric") && (r.value = e("form:eq(" + i + ") input:eq(" + a[o] + ")").autoNumeric("get").toString(),
                    t = !0)
                }
            }),
            t || e.error("None of the successful form inputs are initialized by autoNumeric."),
            r
        },
        getSettings: function() {
            return v(e(this)).eq(0).data("autoNumeric")
        }
    };
    e.fn.autoNumeric = function(t) {
        return x[t] ? x[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error('Method "' + t + '" is not supported by autoNumeric()') : x.init.apply(this, arguments)
    }
    ,
