			...
			<form id="form_add" class="form-horizontal input_mask" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="col-md-10 col-sm-10 col-xs-12 form-group has-feedback">
						...
						<input type="text" autofocus="" name="name" class="form-control has-feedback-left" id="name" value="{{$store->name}}" 
				...
				<div class="form-group">
					<div class="col-md-10 col-sm-10 col-xs-12 form-group has-feedback">
						<label>Address </label>
						<input type="text" autofocus="" class="form-control has-feedback-left" id="address" name="address" value="{{$store->address}}"  
				...
				<div class="form-group">
					<div class="col-md-10 col-sm-10 col-xs-12 form-group has-feedback">
						...
						<textarea class="form-control" id="description" rows="2" placeholder="Description for store...">{{$store->description}}</textarea>
					</div>
				</div>
...
<script type="text/javascript">
	...
	var address = "";
	var center = {lat:<?php echo $store->lat ?>,lng:<?php echo $store->lng ?>};
    function initMap(){
		//Khoi tao map
