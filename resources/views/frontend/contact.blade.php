...
<div class="breadcumb-area" style="background-image: url(frontend/Customer/images/bg1.jpg);">
		...
		<div class="contact-form-area">
			<div class="row">
				<div class="col-12 col-md-5">
					<div class="contact-form-sidebar item wow fadeInUpBig" data-wow-delay="0.3s" style="background-image: url(frontend/Customer/images/bg-img/contact.jpg);">
					</div>
				</div>
